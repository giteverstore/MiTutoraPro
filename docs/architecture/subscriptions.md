...
M8.2 adds a provider-independent captured-payment activation seam while retaining the same plan registry and calendar-extension rules. It does not add checkout or recurring billing. See [Provider-independent payment and payout foundation](payment-payout-foundation.md).
