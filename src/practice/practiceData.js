...
const legacyPracticeQuestions = [
  {
    ...
    subtopic: 'basic-conditions',
    questionType: 'implementation',
    skills: ['conditional-reasoning', 'parity-checking'],
    estimatedMinutes: 8,
    xp: 40,
    blocks: [
  ...
  },
  {
    ...
    topic: 'Loops',
    category: 'fundamentals',
    subtopic: 'accumulators-counters',
    questionType: 'implementation',
    skills: ['loop-iteration', 'numeric-accumulation'],
    estimatedMinutes: 10,
    xp: 50,
    blocks: [
  ...
  },
  {
    ...
    topic: 'Strings',
    category: 'fundamentals',
    subtopic: 'string-transformation',
    questionType: 'implementation',
    skills: ['string-manipulation', 'sequence-reversal'],
    estimatedMinutes: 8,
    xp: 45,
    blocks: [
  ...
  },
  {
    ...
    topic: 'Lists',
    category: 'fundamentals',
    subtopic: 'searching-counting',
    questionType: 'implementation',
    skills: ['list-traversal', 'maximum-selection'],
    estimatedMinutes: 12,
    xp: 70,
    blocks: [
  ...
  },
  {
    ...
    topic: 'Dictionaries',
    category: 'fundamentals',
    subtopic: 'counting-frequency-tracking',
    questionType: 'implementation',
    skills: ['dictionary-counting', 'frequency-tracking'],
    estimatedMinutes: 16,
    xp: 90,
    blocks: [
  ...
  },
  {
    ...
    topic: 'Strings',
    category: 'fundamentals',
    subtopic: 'string-validation-edge-cases',
    questionType: 'implementation',
    skills: ['string-normalization', 'palindrome-validation'],
    estimatedMinutes: 20,
    xp: 120,
    blocks: [
