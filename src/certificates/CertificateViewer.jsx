      ...
      <div className="certificate-viewer" role="dialog" aria-modal="true" aria-labelledby="certificate-viewer-title">
        ...
        <div className="certificate-viewer-body">
          <div className="certificate-preview">
            ...
            <div><span>Issued {formatDate(certificate.issueDate)}</span><span>Credential {certificate.credentialId}</span></div>
          </div>
          <aside className="certificate-viewer-details">
            ...
            <div className="certificate-viewer-actions">
              ...
              <button className="button button--secondary" type="button" onClick={() => onCopy(certificate.verificationUrl, 'Verification link')}><Link2 /> Copy Verification Link</button>
            </div>
          </aside>
        </div>
      </div>
