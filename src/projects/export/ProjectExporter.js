...
export class ProjectExporter {
  async createArchive(project, submission, type = 'blob') {
    ...
    root.file('README.md', readme(project)); root.file(project.template.sourcePath, submission); root.file(project.template.testPath, publicTests(project)); root.file('requirements.txt', ''); root.file('.gitignore', '__pycache__/\n*.py[cod]\n.venv/\n');
